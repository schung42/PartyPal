(function() {
  ...
  //Calculates the total number of drinks based on the number of people and their drinking habits
  ...
  //Actual Calculation of how much alcohol you need to buy
  ...
  //Check if check boxes are checked, and if they are, call doCalculate()
  calculate = function() {
    var beerSelected, liquorSelected, wineSelected, collegeMode;
    var music = AudioFX('assets/js/airhorn.mp3');
    collegeMode = $("#isCollegeMode").is(':checked');
    beerSelected = $("#isBeerServed").is(':checked');
    wineSelected = $("#isWineServed").is(':checked');
    liquorSelected = $("#isLiquorServed").is(':checked');
    ...
    if(collegeMode){
        music.play();
        heavyDrinksFirstHour = 6;

        avgDrinksFirstHour = 4;

        lightDrinksFirstHour = 2;

        heavyDrinksSubsHour = 4;

        avgDrinksSubsHour = 3;

        lightDrinksSubsHour = 1.5;
    }
